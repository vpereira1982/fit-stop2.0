var Summary = (props) => (
  <div className="summary">
    ...
    <div className="summaryStats">
	    ...
	    <h3 className="summaryTitle"> Length of Workout: </h3> {props.workoutLengthInMins}
	    <h3 className="summaryTitle"> Warmups: </h3>{props.currentWorkout[0].name}, {props.currentWorkout[1].name}, {props.currentWorkout[2].name}
